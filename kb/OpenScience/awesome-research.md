...
* _The dangerous myth of the “independent researcher”_ \([James Hayton, Oct. 2022](https://phd.academy/blog/the-myth-of-the-independent-researcher/)\)
    * Archive: [https://web.archive.org/web/20221004064408/https://phd.academy/blog/the-myth-of-the-independent-researcher/](https://web.archive.org/web/20221004064408/https://phd.academy/blog/the-myth-of-the-independent-researcher/)
* _Using LaTeX for Report Writing:_ [https://www.southampton.ac.uk/~fangohr/computing/latex/latex_for_report_writing_HF.pdf](https://www.southampton.ac.uk/~fangohr/computing/latex/latex_for_report_writing_HF.pdf)
    * Archive: [https://web.archive.org/web/20241115004205/https://www.southampton.ac.uk/~fangohr/computing/latex/latex_for_report_writing_HF.pdf](https://web.archive.org/web/20241115004205/https://www.southampton.ac.uk/~fangohr/computing/latex/latex_for_report_writing_HF.pdf)
...
* __LaTeX oriented resources:__
    * LaTeX to HTML via Pandoc: [https://www.danwjoyce.com/data-blog/2018/2/20/latex-to-html-via-pandoc](https://www.danwjoyce.com/data-blog/2018/2/20/latex-to-html-via-pandoc)
    * Compiling LaTeX to html with pandoc: [https://www.homepages.ucl.ac.uk/~ucahmto/elearning/latex/2019/06/10/pandoc.html](https://www.homepages.ucl.ac.uk/~ucahmto/elearning/latex/2019/06/10/pandoc.html)
    * Using Pandoc to Convert LaTeX to HTML and MathML: [https://sc.edu/about/offices_and_divisions/digital-accessibility/toolbox/math/pandoc/](https://sc.edu/about/offices_and_divisions/digital-accessibility/toolbox/math/pandoc/)
    * StackOverflow discussion on "Converting complete latex to html": [https://tex.stackexchange.com/questions/386278/converting-complete-latex-to-html](https://tex.stackexchange.com/questions/386278/converting-complete-latex-to-html)
    * Putting TeX/LaTeX on the Web: [https://www.maths.cam.ac.uk/computing/software/tex/puttingTeXontheWeb](https://www.maths.cam.ac.uk/computing/software/tex/puttingTeXontheWeb)
    
## Platforms & Other Resources

### Publishing Platforms

* _Hyper Articles en Ligne_: [https://hal.science/](https://hal.science/)
    * Alternative Domain: [https://hal.archives-ouvertes.fr/](https://hal.archives-ouvertes.fr/)
    * Wikipedias: [https://en.wikipedia.org/wiki/HAL_(open_archive)](https://en.wikipedia.org/wiki/HAL_(open_archive))

### Science Forums

* _Science Forums_: [https://scienceforums.net/](https://scienceforums.net/)
* _SciForums_: [https://www.sciforums.com/](https://www.sciforums.com/)
* _Science Buddies_: [https://www.sciencebuddies.org/](https://www.sciencebuddies.org/)

### Quantitative Analysis & Data Science

* __Data Science: Guide for Independent Projects:__ [https://ucsd.libguides.com/data-science/projects](https://ucsd.libguides.com/data-science/projects)
* __Packages for Statistical Analysis:__
    * __Orange Data Mining Utility:__ [https://orangedatamining.com/](https://orangedatamining.com/)
    * __NURBS-Python:__ package for developing [Non-Uniform Rational B-Splines](https://en.wikipedia.org/wiki/Non-uniform_rational_B-spline) curves: [https://github.com/orbingol/NURBS-Python](https://github.com/orbingol/NURBS-Python)
        * NURBS-Python Documentation: [https://nurbs-python.readthedocs.io/en/5.x/](https://nurbs-python.readthedocs.io/en/5.x/)
    * __Symfit:__ Python Library for Curve/Distribution Fitting: https://github.com/tBuLi/symfit
        * Symfit documentation: [https://symfit.readthedocs.io/en/stable/index.html](https://symfit.readthedocs.io/en/stable/index.html)
    * __TinyDB:__ flat-file equivalent of a MongoDB NoSQL database: [https://tinydb.readthedocs.io](https://tinydb.readthedocs.io)
...
* __About Topic Modelling:__
    * [Topic Modelling in Python](https://ourcodingclub.github.io/tutorials/topic-modelling-python/) __\[with hashtags\]__
    * _8 Limitations of Topic Modelling Algorithms on Short Text_ (Stoy, Jul 2021): [https://lazarinastoy.com/topic-modelling-limitations-short-text/](https://lazarinastoy.com/topic-modelling-limitations-short-text/)
    * Evaluating Topic Models: [https://mattilyra.github.io/2017/07/30/evaluating-topic-models.html](https://mattilyra.github.io/2017/07/30/evaluating-topic-models.html)
    * IBM Article on _Latent Dirichlet allocation_ and how it relates to Topic Modelling: [https://www.ibm.com/think/topics/latent-dirichlet-allocation](https://www.ibm.com/think/topics/latent-dirichlet-allocation)
    * _Mastering Text Analysis and Topic Modeling with spaCy and Gensim_ (Sayah, Sept. 2022): [https://medium.com/@sayahfares19/text-analysis-topic-modelling-with-spacy-gensim-4cd92ef06e06](https://medium.com/@sayahfares19/text-analysis-topic-modelling-with-spacy-gensim-4cd92ef06e06)
* __Applied Statistics:__ (Donatello & Roualdes): [https://norcalbiostat.github.io/AppliedStatistics_notes/](https://norcalbiostat.github.io/AppliedStatistics_notes/)
* B. Berisha, E. Mëziu, and I. Shabani, “Big data analytics in Cloud computing: an overview,” _J Cloud Comp, vol. 11, no. 1_, Aug. 2022, doi: [10.1186/s13677-022-00301-w](https://doi.org/10.1186/s13677-022-00301-w)
...
* C. Wang, M.-H. Chen, E. Schifano, J. Wu, and J. Yan, “Statistical methods and computing for big data,” _Statistics and Its Interface, vol. 9, no. 4, pp. 399–414_, 2016, doi: [10.4310/sii.2016.v9.n4.a1](https://doi.org/10.4310/SII.2016.v9.n4.a1)
* C. H. Aladag, "New Kind of Statistical Methods," _Journal of Mathematics and Statistics_, vol. 10, no. 4, pp. 423–425, Apr. 2014, doi: [https://doi.org/10.3844/jmssp.2014.423.425](https://doi.org/10.3844/jmssp.2014.423.425)
* D. Comaniciu and P. Meer, "Mean Shift: A Robust Approach Toward Feature Space Analysis," _IEEE TRANSACTIONS ON PATTERN ANALYSIS AND MACHINE INTELLIGENCE_, vol. 24, no. 5, 2002, [https://web.archive.org/web/20051124055814/https://courses.csail.mit.edu/6.869/handouts/PAMIMeanshift.pdf](https://web.archive.org/web/20051124055814/https://courses.csail.mit.edu/6.869/handouts/PAMIMeanshift.pdf)
...
* __David Salazar Technical Blog Posts on Quantitative & Statistical Analysis:__ [https://david-salazar.github.io/archive.html](https://david-salazar.github.io/archive.html)
* E. Castillo et al., "Fitting Continuous Bivariate Distributions to Data," _Journal of the Royal Statistical Society_, Series D (The Statistician), vol. 26, no. 3, 1997, [https://www.jstor.org/stable/2988571](https://www.jstor.org/stable/2988571)
* __Essential Notes on Statistical Mechanics__, Dr. Luca Donati, [https://web.archive.org/web/20250809051149/https://www.zib.de/userpage/donati/stochastics2023/05/lecture_notes/Notes_Statistical_Mechanics.pdf](https://web.archive.org/web/20250809051149/https://www.zib.de/userpage/donati/stochastics2023/05/lecture_notes/Notes_Statistical_Mechanics.pdf)
...
* J. Fan, F. Han, and H. Liu, “Challenges of Big Data analysis,” National Science Review, vol. 1, no. 2, pp. 293–314, Feb. 2014, doi: [10.1093/nsr/nwt032](https://doi.org/10.1093/nsr/nwt032)
* M. Dean, "Probability Weighting," Lecture Notes for Behavioural Economics Class, [https://web.archive.org/web/20171013075400/https://www.columbia.edu/~md3405/BE_Risk_4_15.pdf](https://web.archive.org/web/20171013075400/https://www.columbia.edu/~md3405/BE_Risk_4_15.pdf)
...
* W. K. Estes, "Toward a Statistical Theory of Learning," [https://web.archive.org/web/20241029193355/https://worthylab.org/wp-content/uploads/2017/09/estes_1950.pdf](https://web.archive.org/web/20241029193355/https://worthylab.org/wp-content/uploads/2017/09/estes_1950.pdf)
